...
{
    class LedManager_NVD_Side : LedManager
    {
        private Thread t;
        ...
        protected override void updateLed_NoAnimation()
        {
            ...
            {
                _NDA.NDA_SetIlluminationParm_RGB(i, 21, 1, 0, 0, 0, 4, 0, 0, ledColor.R, ledColor.G, ledColor.B, true);
            }
            this.PatientlyWait();
        }
        ...
        protected override void updateLed_Breathing()
        {
            for (int i = 0; i < this.adapterIndexes.Count; i++)
            {
                _NDA.NDA_SetIlluminationParm_RGB(i, 27, 1, 0, 0, 0, 4, 0, 0, ledColor.R, ledColor.G, ledColor.B, false);
            }
            this.PatientlyWait();
        }
        ...
        protected override void updateLed_Flashing()
        {
            for (int i = 0; i < this.adapterIndexes.Count; i++)
            {
                _NDA.NDA_SetIlluminationParm_RGB(i, 28, 1, 0, 100, 100, 4, 0, 0, ledColor.R, ledColor.G, ledColor.B, false);
            }
            this.PatientlyWait();
        }
        ...
        protected override void updateLed_DoubleFlashing()
        {
            for (int i = 0; i < this.adapterIndexes.Count; i++)
            {
                _NDA.NDA_SetIlluminationParm_RGB(i, 30, 1, 0, 10, 15, 4, 2, 0, ledColor.R, ledColor.G, ledColor.B, false);
            }
            this.PatientlyWait();
        }
        ...
        protected override void updateLed_Off()
        {
            for (int i = 0; i < this.adapterIndexes.Count; i++)
            {
                _NDA.NDA_SetIlluminationParm_RGB(i, 24, 1, 0, 0, 0, 0, 0, 0, ledColor.R, ledColor.G, ledColor.B, true);
            }
            this.PatientlyWait();
        }
